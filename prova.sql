...
-- 1
insert into livros (titulo, autor, ano_publicacao, disponivel, categoria, isbn, editora, quantidade_paginas, idioma) values
('As cronicas de narnia', 'C.S lewis', 1950, TRUE, 'fantasia', '978-0064471190', 'HarperCollins', 768, 'Francês');
...
-- 6
select titulo,categoria, sum(titulo) from livros
group by categoria;
...
-- 8
select quantidade_paginas, avg(quantidade_paginas) from livros;
